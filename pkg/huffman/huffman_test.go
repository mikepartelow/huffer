...
func TestMakeTable(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			want: huffman.Table{
				'D': huffman.Code{Width: 2, Value: 0b00},
				'_': huffman.Code{Width: 2, Value: 0b01},
				'A': huffman.Code{Width: 2, Value: 0b10},
				'E': huffman.Code{Width: 3, Value: 0b110},
				'C': huffman.Code{Width: 4, Value: 0b1110},
				'B': huffman.Code{Width: 4, Value: 0b1111},
			},
		},
	}
